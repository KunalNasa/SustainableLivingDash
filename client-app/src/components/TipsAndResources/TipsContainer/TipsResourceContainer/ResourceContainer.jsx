...
const ResourceContainer = ({data}) => {
  return (
    <div className='TipsContainer p-5 m-5 flex flex-col items-center justify-center'>
            <h2 className='text-4xl font-serif'>Top Sustainable Resources for Eco-Friendly Living</h2>
            ...
            <div className='cardContainer p-1 m-5 max-w-[75vw] items-center justify-center flex-wrap overflow-auto flex no-scrollbar max-h-[40vh]'>
                {data.map((item) => (
                    <button
                        className="cards mx-2 my-5 transition duration-150 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:shadow-2xl overflow-y-auto no-scrollbar w-[30%] bg-purple-400 h-32 text-center shadow-lg border rounded-3xl"
                    >
