  ...
  return (
    <div className='w-full flex flex-col items-center justify-center px-4'>
      <div className='w-full md:w-3/4 p-4 md:p-8'>
        <h1 className='text-xl md:text-6xl lg:text-8xl font-serif text-center'>Sustainable Living Dashboard</h1>
        <p className='text-base md:text-lg lg:text-xl font-serif mt-4 text-center'>
