...
const UserRegister = ({updateReloadState}) => {
  ...
  return (
    ...
    <div className='flex h-[90vh] w-full shadow-lg bg-purple-200 items-center justify-center flex-col'>
        ...
        <h3 className='font-bold mb-5 text-2xl'>User Registration</h3>
            <label className='text-left font-serif w-full p-1' htmlFor="">username</label>
            ...
            <label className='text-left font-serif w-full p-1' htmlFor="">password</label>
            ...
            <button className='border rounded-lg p-2 m-2 bg-purple-500 mt-6 transition duration-150 ease-in-out transform hover:scale-105 text-lg w-40 shadow-md font-bold' type='submit'>Register</button>
        </form>
        <div>
